...
You are to choose 3 trees such that their total cost is minimum.
 Return that cost.
...
Output Format
Return an integer denoting the minimum cost of choosing 3 trees whose
 heights are strictly in increasing order, if not possible, -1.
