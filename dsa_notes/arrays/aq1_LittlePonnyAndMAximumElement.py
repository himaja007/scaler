...
He wants your help in finding out the minimum number of operations
 required such that the maximum element of the resulting array is B.
...
class Solution:
    ...
    def solve(self, A, B):
        ...
        return found
s=Solution()
print(s.solve([2, 4, 3, 1, 5], 3))
print(s.solve([1, 4, 2], 3))
print(s.solve([1, 4, 2, 3], 3))